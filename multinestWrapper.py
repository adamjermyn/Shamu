...
def run(outputDirectory, outputPrefix, ranges, parameters, loglikelihood, log_zero=-1e100, n_live_points=400):
	'''
	...
	result = solve(LogLikelihood=loglikelihood, Prior=pri, n_dims = ndim, importance_nested_sampling=False,resume=False,outputfiles_basename=prefix,verbose=True, n_live_points=n_live_points, log_zero=log_zero)
